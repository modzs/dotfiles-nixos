...
- Your environment: your NixOS release, whether you installed from the graphical or minimal ISO, and any relevant NixOS or home-manager generation details.

Please note that this configuration has been evaluated but never built or booted on real hardware, so a report that it fails on a real machine is genuinely useful rather than a duplicate.
